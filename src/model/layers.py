...
class CNNBlock(eqx.Module):
    ...
    lnorm3  : layers.LayerNorm
    extrct2 : layers.Conv2d
    lnorm4  : layers.LayerNorm
    conv2_3x3: layers.Conv2d
    lnorm5  : layers.LayerNorm
    conv2_1x1: layers.Conv2d
    lnorm6  : layers.LayerNorm
